...
#define CMD_TABLE_TEMPERATURECONTROL \
    ...
    DSCP_CMD_ENTRY(DSCP_CMD_TCI_TURN_FAN, TempControl_ThermostatFanSetOutput), \
    ...
    DSCP_CMD_ENTRY(DSCP_CMD_TCI_TURN_ON_RELAY, TempControl_RelayControl), \
    DSCP_CMD_ENTRY(DSCP_CMD_TCI_TURN_OFF_RELAY, TempControl_TurnOffRelay),\
	DSCP_CMD_ENTRY(DSCP_CMD_TCI_REVISE_THERMOS_TEMP, TempControl_ReviseThermostatTemp)
