...
#define CMD_TABLE_SOLENOID_VALVE \
	...
	DSCP_CMD_ENTRY(DSCP_CMD_SVI_SET_GAIN_MAP, SolenoidVale_SetGainMap), \
	DSCP_CMD_ENTRY(DSCP_CMD_SVI_GET_GAIN_MAP, SolenoidVale_GetGainMap),\
	DSCP_CMD_ENTRY(DSCP_CMD_SVI_SET_VALVE_MAP_NORMAL_OPEN, SolenoidVale_SetValvesMapNormalOpen)
