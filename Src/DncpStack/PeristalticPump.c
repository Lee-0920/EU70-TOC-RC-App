 ...
 * @param len
 */
void PeristalticPump_GetTotalPumpStatus(DscpDevice* dscp, Byte* data, Uint16 len)
{
	Uint16 map = 0;
	Uint16 mark = 1;

//	for (Uint8 i=0; i<DNCP_PUMP_TOTAL; i++)
//	{
//		if (PUMP_IDLE != PeristalticPumpDriver_GetStatus(i))
//		{
//			map = map|(mark<<i);
//		}
//	}

    DscpDevice_SendResp(dscp, &map, sizeof(Uint16));
}
