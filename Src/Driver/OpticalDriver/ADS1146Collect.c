...
// START
#define ADS1146_START_PIN        GPIO_Pin_12
#define ADS1146_START_GPIO       GPIOE
#define ADS1146_START_RCC        RCC_AHB1Periph_GPIOE
...
// DRDY
#define ADS1146_DRDY_PIN         GPIO_Pin_4
...
//    ADS1146Collect_ADS1146SendByte(GAIN_64 | RATE_160);
    ADS1146Collect_ADS1146SendByte(GAIN_128 | RATE_2000);
...
//    ADS1146_CS_HIGH();          // 失能
    ...
    if(channel == 2)			//增加参考端的延时，保证参考测量的周期占比各为2ms
	{
		System_Delay(1);
	}
