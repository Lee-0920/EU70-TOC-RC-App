...
{
    RCC_AHB1PeriphClockCmd(ADCx_CHANNELA_GPIO_CLK | ADCx_CHANNELB_GPIO_CLK | ADCx_CHANNELC_GPIO_CLK | ADCx_CHANNELD_GPIO_CLK , ENABLE);
...
//    TRACE_INFO("\n ad: %d",TempADCollect_ADFilter(temperatureAD));
